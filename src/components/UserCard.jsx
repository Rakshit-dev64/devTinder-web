...
const UserCard = ({ user }) => {
  ...
  return (
    user && (
      <div className="relative w-80 sm:w-96 mx-auto h-[600px] sm:h-[600px] rounded-xl overflow-hidden shadow-2xl shadow-black transition-all duration-500 ease-out transform hover:scale-105 hover:shadow-3xl hover:shadow-blue-900/30">
        <img
          src={profileURL}
          alt="pfp"
